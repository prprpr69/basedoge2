            ...
            <div className="relative select-none w-full max-w-[940px] mx-auto">
              ...
              <AnimatePresence>
                {isPaused && (
                  ...
                  >
                    <div className="text-8xl font-bold text-[#00F0FF] mb-8 tracking-widest">PAUSED</div>
                    {pauseCountdown > 0 && (
                      <motion.div 
                        key={pauseCountdown}
                        initial={{ scale: 0.6, opacity: 0 }}
                        animate={{ scale: 1, opacity: 1 }}
                        className="text-[180px] font-black text-[#00F0FF] mb-8"
                      >
                        {pauseCountdown}
                      </motion.div>
                    )}
                    <div className="text-xl text-white/70 mb-12">PRESS P TO RESUME</div>
                    <button onClick={() => {
                      setPauseCountdown(3);
